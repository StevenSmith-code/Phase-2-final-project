...
const handleClick = () =>{
  ...
  return (
    <div onClick={handleClick} className='bg-gray-200 h-80 w-80 rounded-lg cursor-pointer hover:scale-110 transition duration-100 shadow-lg flex flex-col items-center'>
